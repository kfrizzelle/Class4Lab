...
public class TriangleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("".equals(a)){
            Double answer = Math.sqrt(Math.pow(Double.valueOf(c), 2)-Math.pow(Double.valueOf(b), 2));
            request.setAttribute("answer", answer);
        }else{
            Double answer = Math.sqrt(Math.pow(Double.valueOf(a), 2)+Math.pow(Double.valueOf(b), 2));
            request.setAttribute("answer", answer);
        }
